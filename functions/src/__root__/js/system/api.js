...
(function (window, site) {
  ...
  var apiRoot = 'https://us-central1-backpacks-5bda5.cloudfunctions.net/';
  if(window.location.hostname == 'localhost'){
    apiRoot = 'http://localhost:5001/backpacks-5bda5/us-central1/'
  }
  ...
  site.api.register('createSKUInStripeProduct', createSKUInStripeProduct);
  function createSKUInStripeProduct(params, success, error, complete) {
    var apiCall = ('createSKUInStripeProduct').toString();
    return this.api(httpMethod.get, apiCall, params, success, error, complete);
  }

  //create collection/table for this site
  site.api.register('createCollectionObject', createCollectionObject);
  function createCollectionObject(params, success, error, complete) {
    var apiCall = ('createCollectionObject').toString();
    return this.api(httpMethod.get, apiCall, params, success, error, complete);
  }

  //create collection/table for this site
  site.api.register('createProductInStripe', createProductInStripe);
  function createProductInStripe(params, success, error, complete) {
    var apiCall = ('createProductInStripe').toString();
    return this.api(httpMethod.get, apiCall, params, success, error, complete);
  }
